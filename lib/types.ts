// The contract. Both people import from this file. Change it only by mutual agreement.
...
// Actors used by lib/fga.ts canRead() checks.
export type Actor = "buyer_agent" | "vendor_agent" | "buyer_admin" | "vendor_admin";
